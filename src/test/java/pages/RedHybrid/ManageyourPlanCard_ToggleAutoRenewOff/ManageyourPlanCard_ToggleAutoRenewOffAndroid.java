...
public class ManageyourPlanCard_ToggleAutoRenewOffAndroid extends ManageyourPlanCard_ToggleAutoRenewOffAbstract {
    ...
    public ManageyourPlanCard_ToggleAutoRenewOffAndroid() {
        super();
    }
    ...
    public void CheckUIOfManageYourPlanCard() {
        ...
        String actualManageYourPlanExpirationDate = ManageYourPlanExpirationDate.getText();
    ...
    public void openDeepLinkForChangePlanForNextMonth() {
         driver.navigate().to("myvodafone://CHANGE_NEXT_PLAN_RH_BUNDLES");
    }

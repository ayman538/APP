...
public class AutoRenewReminderAndroid extends AutoRenewReminderOverlayAbstract{
    DashboardV4ResponseModel DashboardResponse ;
    public AutoRenewReminderAndroid(){super();}
    ...
    public void planTabIsDisplayed() {
      ...
      assertEquals("true",planTab.getAttribute("selected"));
      Assert.assertTrue(planTitle.isDisplayed());
    }
}

...
public class RedHybrid_PaymentMethodOverlayNoPaymentMethodAddedLogic_IOS extends RedHybrid_PaymentMethodOverlayNoPaymentMethodAdded_Abstract {
    ...
    public RedHybrid_PaymentMethodOverlayNoPaymentMethodAddedLogic_IOS(){
        super();
    }
    ...
    public void planChoosed() {
        ...
        System.out.println("ActualPlanName  " + hybridBundelsResponseModel.title);
        ...
        waitForVisibility(plansRecyclerView);
        plansRecyclerView.click();

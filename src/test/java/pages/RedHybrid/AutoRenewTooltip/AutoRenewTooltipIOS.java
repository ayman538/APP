...
public class AutoRenewTooltipIOS extends AutoRenewTooltipAbstract{
    ...
    public void ValidateAutoRenewTip(){
        ...
        assertIsTrueSoftly("invalid tip Title",driver.findElement(
                By.name(dashboard.tooltips.get(0).items.get(0).title)) .isDisplayed());
        assertIsTrueSoftly("invalid tip description",driver.findElement(
                By.name(dashboard.tooltips.get(0).items.get(0).description)) .isDisplayed());
        ThanksCTA.click();

...
public class AddNewPlan_PaymentMethodOverlayLogic_Android extends AddNewPlan_PaymentMethodOverlay_Abstract{

    public AddNewPlan_PaymentMethodOverlayLogic_Android(){
        super();
    }
    ...
    public void checkTheUIOfCellWithPromotedPlan() {
        ...
        if (PlanHasPromoTotalData != null){
            while(!driver.findElement(By.xpath(GetXpath(planPrice))).isDisplayed()){
                ...
                SwipeToElement(driver.findElement(By.xpath(GetXpath(PlanHasPromoTotalData))),"Left");
            }

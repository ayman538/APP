...
public class ChangeNextPlaneChangeProcessing_Android extends ChangeNextPlaneChangeProcessing_Abstract {
    ...
    public ChangeNextPlaneChangeProcessing_Android() {
        super();
    }
    ...
    public void validateChangePlanNotificationScreenUI() {
        ...
        Assert.assertTrue(checkMarkIcon.isDisplayed());
    ...
    public void validate_UI_of_confirmation_screen_in_changePlan(String JourneyType) throws JsonProcessingException {
        ...
        switch (JourneyType) {
            ...
            case "Auto-Renew" -> {
                ...
                expectedDescription = "Your auto-renewal\nhas been updated";

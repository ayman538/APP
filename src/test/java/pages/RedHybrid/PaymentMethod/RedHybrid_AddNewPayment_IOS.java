...
public class RedHybrid_AddNewPayment_IOS extends RedHybrid_AddNewPayment {
    ...
    public void ValidatePaymentCardIsAdded() {
        waitForVisibility(RedHybrid_PaymentHeader);
        AssertResult(RedHybrid_PaymentTitle.getText(), "Payments");

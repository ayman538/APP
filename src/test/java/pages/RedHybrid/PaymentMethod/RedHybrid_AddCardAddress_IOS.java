...
public class RedHybrid_AddCardAddress_IOS extends RedHybrid_AddCardAddress {

    AddressResponseModel response;
    public RedHybrid_AddCardAddress_IOS() {
        super();
    ...
    public void checkDropdownList() {
        ...
        waitForVisibility(RedHybrid_selectAddressTitle);
        AssertResult(RedHybrid_selectAddressTitle.getText(),"Select an address");
        AssertDisplayed(RedHybrid_selectAddressTextField.isDisplayed());
    ...
    public void checkContinueBtnDimmed() {
        ...
        Assert.assertFalse(RedHybrid_ContinuePaymentCTA.isEnabled());
    }

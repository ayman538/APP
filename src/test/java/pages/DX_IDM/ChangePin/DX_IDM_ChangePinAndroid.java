...
public class DX_IDM_ChangePinAndroid extends DX_IDM_ChangePinAbstract {


    private final AppSettingsAndroid AppSettings;

    public DX_IDM_ChangePinAndroid()  {
        super();
    ...
    public void EnterPinFields() {
        waitForVisibility(DX_IDM_PinField1);
        DX_IDM_PinField1.sendKeys("2");
        DX_IDM_PinField2.sendKeys("5");
        DX_IDM_PinField3.sendKeys("8");
        DX_IDM_PinField4.sendKeys("0");
    }

...
@Deprecated
public class DX_IDM_ForgetPasswordLogic extends DX_IDM_ForgetPasswordPO{

    private DX_IDM_FullLoginPO dx_idm_fullLoginPO;
    private DX_IDM_SoftLoginLogic_Abstract dx_idm_softLoginLogic;
    private final Config config =new Config();
    private DX_IDM_UFLLogic dx_idm_uflLogic;
    private Forgetpassword forgetpassword;
    private String tempPass;
    private String username;

    public DX_IDM_ForgetPasswordLogic(){
        super();
        if (config.isAndroid()) dx_idm_softLoginLogic = new DX_IDM_SoftLoginLogicAndroid();
        if (config.isIos()) dx_idm_softLoginLogic = new DX_IDM_SoftLoginLogic_IOS();
        dx_idm_uflLogic = new DX_IDM_UFLLogic();

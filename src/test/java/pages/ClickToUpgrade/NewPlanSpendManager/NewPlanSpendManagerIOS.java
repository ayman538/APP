...
public class NewPlanSpendManagerIOS extends NewPlanSpendManagerAbstract {
    ...
    public void VerifyTheGreenBoxAppearsWithCheckmarkAfterSelectingTheValue() {
        ...
        C2U_spendManagerSpendLimitsMenuUnlimitedOption.sendKeys("Unlimited");
        C2U_spendManagerPostSelectionMsg.isDisplayed();
    }

    @Override
    public void scrollToSpendManager() {
        iosScrollToElement(newPlanTermAndCondTitle, "down");
    }
}

...
public class CreditTilePayGiOS extends CreditTilePayGAbstract{
    SegmentResponseModel segmetResponseModel = SegmentUtils.GetSegment();


    public CreditTilePayGiOS() {super();}
    ...
    public void assertCreditTitleTextPrePayIsLow() {
        ...
        System.out.println("Credit tile text : "+DB_creditTileText.getText());
...
//        System.out.println(DB_creditTileAmount.getText()+ "after substring= "+amount);
    }
...
//        System.out.println(DB_creditTileIcon);
    }
    @Override

...
public class Login_Logic_IOS extends Login_Abstract {

    public static boolean HasFaceID = false;
    private By promptLabel = By.name("Speed up your login with Face ID");
    private By PromptBiometricCta = By.xpath("//*[@name='Use Face ID']");
    private By PromptNotNowCta = By.xpath("//*[@name=\"Not right now\"]");

    public Login_Logic_IOS() {
        super();
    }

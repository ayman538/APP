...
public class CategoryBottomSheetLogicIOS extends CategoryBottomSheetAbstract{
    ...
    public void validateExtrasCategoryScreenTitle(String categoryName) throws Exception {
        ...
        if (nativeExtrasSubGroupResponseModelAnalyticsVersion.itemGroups !=null) {
            ...
            WebElement extrasCategoryScreenTitle = findElementBytext("label" ,nativeExtrasSubGroupResponseModelAnalyticsVersion.itemGroups.header.title);

...
public class SpeedCheckerHistoryiOSLogic extends SpeedCheckerHistoryAbstractLogic {

       public SpeedCheckerHistoryiOSLogic () {super();}
    ...
    public void ValidateSpeedHistoryScreenIsDisplayed() {
        ...
        try {
            ...
            System.out.println("testing is done successfully and device location is ON");
        }
        catch (Exception e){
    ...
    public void ClickOnDeletePreviousTestsCTA() {
        try{
            ...
            scrollDownElementOverCenterScreen(DeletePreviousSpeedTests_CTA);
            DeletePreviousSpeedTests_CTA.click();

...
public class UpgradeCardsLogicAndroid extends UpgradeCardsLogicAbstract {
    ...
    public void assertEligibleForUpgradeCardCTA() {
        PlanV3ResponseModel planResponse = PlanUtils.GetPlanV3();
        if (planResponse.cards.get(0).title.contains("eligible to upgrade")) {
            getElementByText(GetXpath(planResponse.cards.get(0).actions.get(0).text)).click();
        } else {
            throw new SkipException("Item not exist in the response");
        }
    ...
    public void AssertPOPUI() {
        waitForVisibility(TradeInUpgradePoPUP_title);
    ...
    public void ValidateDiscountCardAppearance() {
        ScrollToElement(DiscountCardTitle, "up");
...
public void validateASACopy(){
    ...
    public void ValidateBrandsIconsCarousel() throws InterruptedException {
        ...
        ScrollToElement(BrandIconTitle,"down");
        ...
        String [] brands = {"SHOP_APPLE_DEVICES","SHOP_SAMSUNG_DEVICES","SHOP_GOOGLE_DEVICES"};
            ...
            if(brandIconsCarouselResponse.ctas.get(1).journeyKey != null){
                ...
                scrollDownTo(SamsungIcon);
                SamsungIcon.click();
                waitForVisibilityForReinvent(closeInternalWebview, 90);
                AssertDisplayed(closeInternalWebview.isDisplayed());
                closeInternalWebview.click();
            }
    ...
    public void validateUpgradeTypes() {
        ...
        try{
            ...
            System.out.println("API"+(planCardresponse.sections.get(1).title.replace("<b>","").replace("</b>","")));
            Assert.assertTrue(UpgradeTitle.getText().contains((planCardresponse.sections.get(1).title.replace("<b>","").replace("</b>",""))));
            Assert.assertTrue(UpgradeSubTitle.getText().contains(planCardresponse.sections.get(1).text.get(0)));
        } catch (Exception e){
            ScrollToElement(DiscountSubTitle,"up");
            AssertResult(DiscountSubTitle.getText(), planCardresponse.sections.get(0).text.get(0));
        }

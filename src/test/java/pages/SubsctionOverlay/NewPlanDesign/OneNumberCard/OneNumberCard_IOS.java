...
public class OneNumberCard_IOS extends OneNumberCard_Abstract {
    ...
    //Webelement Locators
    By PlanTab = By.xpath("//*[@name='Plan']");
    By OneNumber_ConnectionsNo = By.xpath("//*[@name='one_number_connections']");
    By AddaConnectionCTA = By.xpath("//*[@label='Add a connection']");
    By ConnectionIcon = By.xpath("//*[@name='one_number_connections_icon']");
    By ConnectionName = By.xpath("//*[@name='one_number_connections_name']");
    By ConnectionSerial = By.xpath("//*[@name='one_number_connections_type']");
    By WebviewClose = By.xpath("//*[@name='VFGwebCloseButton']");
    By ViewDetailsCTA = By.xpath("//*[@label='View details']");

    //manage subscription tray
    By SubscriptionTrayTitle = By.id("view_details_tray_title");
    By SubscriptionTrayFriendlyName = By.id("one_number_connection_name");
    By SubscriptionTrayIcon = By.id("one_number_connection_icon");
    By SubscriptionTrayCTN = By.id("one_number_connection_serial");
    By SubscriptionPlanCostTitleLeft = By.id("plan_cost_left_title_text_view");
    By SubscriptionPlanCostTitleRight = By.id("plan_cost_right_title_text_view");
    By SubscriptionPlanCostTextLeft = By.id("plan_cost_left_text");
    By SubscriptionPlanCostTextRight = By.id("plan_cost_right_text");
    By agreementTitle = By.id("plan_agreement_title");
    By SubscriptionContractDateTextLeft = By.id("plan_contract_date_left_text");
    By SubscriptionContractDateTextRight = By.id("plan_contract_date_right_text");
    By tooltipIcon = By.id("imgManagementTrayAgreementView_0");
    By toolTipDescription = By.id("TVdescriptionLabel");
    By toolTipThanksCTA = By.id("TVthanksButton");
    By manageConnectionCTA = By.id("one_number_manage_connection_action");
    By videoPlayer = By.id("one_number_video_web_view");

    //subscription state tray elements
    By TrayTitle = By.xpath("//*[@label='Add OneNumber device']");
    By TrayClose = By.xpath("//*[@name='bottomSheetDismissButtonIdentifier']");
    By TrayIcon = By.xpath("//*[@name='one_number_pending_tray_icon']");
    By TrayDescription = By.xpath("//*[@name='one_number_pending_tray_description']");
    By TraySubDescritpion = By.xpath("//*[@name='one_number_pending_tray_sub_description']");
    By TrayActionCTA = By.xpath("//*[@label='Continue']");
    ...
    public void clickOnGetConnectedCTA() {
        ...
        waitForVisibility(Plan_OneNumber_GetConnected);
    ...
    public void clickOnFindOutMoreCTA() {
        waitForVisibility(Plan_OneNumber_Findoutmore);
    ...
    public void validateCTAsDisplayed() {
        ...
        if (getSegment().contains("CONSUMER")) {
    ...
    public void ClickOnYourPlanAndNavigateToTheNewOneNumber() {
        ...
        if(ConnectionsNo != 3){
            ...
            scrollDownTo(ConnectionSerials.get(ConnectionSerials.size()-1));
        }
    }
    ...
    public void AssertSubscriptionTray() {
        ...
        waitForVisibility(PlanTab);
        AssertDisplayed(driver.findElement(PlanTab).isDisplayed());
    }
    ...
    public void assertOneNumberAgreementSectionAndManageConnectionCTA() {
        ...
        List<WebElement> manageSubscriptionLeftText = driver.findElements(SubscriptionContractDateTextLeft);
        List<WebElement> manageSubscriptionRightText = driver.findElements(SubscriptionContractDateTextRight);
        for(int i=0; i<OneNumberDetailsResponse.planAgreement.list.size(); i++)
        {
            AssertDisplayed(manageSubscriptionLeftText.get(i).isDisplayed());
            Assert.assertEquals(manageSubscriptionLeftText.get(i).getText(), OneNumberDetailsResponse.planAgreement.list.get(i).leftAlignedText);
            AssertDisplayed(manageSubscriptionRightText.get(i).isDisplayed());
            Assert.assertEquals(manageSubscriptionRightText.get(i).getText(), OneNumberDetailsResponse.planAgreement.list.get(i).rightAlignedText);
        }

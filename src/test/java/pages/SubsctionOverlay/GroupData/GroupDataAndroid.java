...
public class GroupDataAndroid extends GroupDataAbstract{

    public GroupDataAndroid(){
        super();
    }
    ...
    public void checkLimitSharerInManageGroupData(){
        ...
        if(MGD_setLimitValue.getText().equals("Off")){
            Assert.assertFalse(MGD_CardSendTextCTA.isEnabled());
            MGD_CardBar.click();
        }
        Assert.assertTrue(MGD_CardSendTextCTA.isEnabled());
    }

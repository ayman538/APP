...
public class DevicePlanIOS extends DevicePlanAbstract {

    public DevicePlanIOS() {
        super();
    }
    ...
    public void checkNextPayment() {
        String nextPayment =deviceLoanDetailsResponseModel.cards.get(1).nextPayment;
        String loanChargesLabel =deviceLoanDetailsResponseModel.cards.get(1).loanChargesLabel;
        String loanChargesValue =deviceLoanDetailsResponseModel.cards.get(1).loanChargesValue;
        AssertResult(getElementByText("//XCUIElementTypeStaticText[@name='"+ nextPayment+ "']").getText(),nextPayment);
        AssertResult(getElementByText("//XCUIElementTypeStaticText[@name='"+ loanChargesLabel+ "']").getText(),loanChargesLabel);
        AssertResult(getElementByText("//XCUIElementTypeStaticText[@name='"+ loanChargesValue+ "']").getText(),loanChargesValue);
    }

    public void checkDevicePlanAmountPaid() {
        System.out.println(deviceLoanDetailsResponseModel.cards.get(1).paidValue);
        System.out.println(SO_DevicePlanPaidAmount);
        String paidValue =deviceLoanDetailsResponseModel.cards.get(1).paidValue;
        AssertResult(getElementByText("//XCUIElementTypeStaticText[@name='"+ paidValue+ "']").getText(),paidValue);
    }
    ...
    public void checkDevicePlanTitle() {
        ...
        Assert.assertEquals(SO_DevicePlanTitle.getText(),deviceLoanDetailsResponseModel.cards.get(1).title);
    }
    ...
    public void checkTotalCareWarrantyAsIncludes() {
        ...
        for (int i = 0; i < deviceLoanDetailsResponseModel.cards.get(1).sections.get(0).list.size(); i++) {
            if (deviceLoanDetailsResponseModel.cards.get(1).sections.get(0).list.get(i).title.equals("Total Care Warranty")) {
                Assert.assertTrue((getElementByText("Total Care Warranty").getText().contains(deviceLoanDetailsResponseModel.cards.get(1).sections.get(0).list.get(i).title)));
                found = true;
            }
        }
        if (!found) {
    ...
    public void checkBatteryRefreshAsIncludes() {
        ...
        boolean found = false;
        for (int i = 0; i < deviceLoanDetailsResponseModel.cards.get(1).sections.get(0).list.size(); i++) {
            if (deviceLoanDetailsResponseModel.cards.get(1).sections.get(0).list.get(i).title.equals("Battery Refresh")) {
                waitForVisibility(SO_DevicePlan_BatteryRefreshLink);
                System.out.println(SO_DevicePlan_BatteryRefreshLink.getText());

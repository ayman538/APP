...
######################################## E2E Scenarios for Regression ##################################################

  @TC_1928508 @E2E @AppFreshInstalled @10.51
  Scenario: Check the new Welcome Flow screens using wifi with Accepting All Cookies E2E_FUNC
  ...
  @TC_1928754 @E2E @AppFreshInstalled @10.51
  Scenario: Check the links inside the welcome flow E2E_FUNC
    And I validate 'Before you get started' screen
    And I click on App Privacy Supplement Link
    Then I redirected to App Privacy Supplement screen
    And I click on 'Back' CTA in Welcome flow screens
    ...
    And I click on 'Continue' CTA in the Welcome flow Screens
    And I click on 'Terms and conditions' Link
    Then I redirected to Terms and Conditions screen
    And I click on Ok CTA
    Then I redirected to 'We Value Your Privacy' screen
    And I click on 'CookiePolicy' link
    Then I should be navigated to CookiePolicy screen with collapsed chevrons
    Then I click on the first two policies they will expand to show their description
    Then I click on the last two policies it will redirect the user to another screen regarding each policy
    And I click on 'Back' CTA in Welcome flow screens
    And I click on 'Manage cookies' CTA
    Then I redirected to 'Cookie permission' screen
    ...
    #Interact with permissions popups
    And I am MVA user and logged in using Soft Login
    Then click on my Settings on dashboard tray


  @TC_1928833 @E2E @AppFreshInstalled @10.51
  Scenario: Check the flow of the Welcome Flow screens using 3G after reseting the app & Reject All Cookies_FUNC
    And I validate 'Before you get started' screen
    And I toggle on 'Ts&Cs'
    And I click on 'Continue' CTA in the Welcome flow Screens
    And I click on 'Accept all cookies' CTA in 'We Value Your Privacy' screen
